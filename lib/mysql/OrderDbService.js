...
var initOrderInfo = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(orderInfo) {
    ...
    return function initOrderInfo(_x) {
...
var unifiedOrderInfo = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(prepay_id, out_trade_no) {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.prev = 0;
                        _context2.next = 3;
                        return mysql('cOrder').count('out_trade_no as hasOrder').where({
                            out_trade_no: out_trade_no
                        });
    ...
    return function unifiedOrderInfo(_x2, _x3) {
