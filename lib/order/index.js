...
function unifiedorder(req) {
    ...
    return new Promise(function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(resolve, reject) {
            var _req$body, device_info, body, detail, attach, total_fee, spbill_create_ip, goods_tag, product_id, openid, appid, mch_id, fee_type, notify_url, limit_pay, sign_type, trade_type, nonce_str, time_start, time_expire, params, out_trade_no, paramXML, res, result;
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _req$body = req.body, device_info = _req$body.device_info, body = _req$body.body, detail = _req$body.detail, attach = _req$body.attach, total_fee = _req$body.total_fee, spbill_create_ip = _req$body.spbill_create_ip, goods_tag = _req$body.goods_tag, product_id = _req$body.product_id, openid = _req$body.openid;
                        ...
                        case 5:
                            ...
                            time_expire = moument().utcOffset(8).add(config.mch_expire || 30, 'm').format('YYYYMMDDHHmmss');
