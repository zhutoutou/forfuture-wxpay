...
function unifiedorder(req) {
    ...
    return new Promise(function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(resolve, reject) {
            var _req$query, device_info, body, detail, attach, total_fee, spbill_create_ip, goods_tag, product_id, openid, origin, findRes, appid, mch_id, fee_type, notify_url, limit_pay, sign_type, trade_type, nonce_str, time_start, time_expire, params, out_trade_no, paramXML, res, result;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 10:
                            ...
                            appid = undefined;
                            _context.t0 = origin;
                            _context.next = _context.t0 === 0 ? 16 : _context.t0 === 1 ? 18 : 20;
                            break;
