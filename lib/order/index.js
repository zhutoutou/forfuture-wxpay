...
function unifiedorder(req) {
    ...
    return new Promise(function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(resolve, reject) {
            var spbill_create_ip, _req$body, device_info, body, detail, attach, total_fee, goods_tag, product_id, openid, unionid, origin, findRes, conf, appid, mch, mch_id, fee_type, notify_url, limit_pay, sign_type, trade_type, nonce_str, time_start, time_expire, params, out_trade_no, paramXML, res, result;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _req$body = req.body, device_info = _req$body.device_info, body = _req$body.body, detail = _req$body.detail, attach = _req$body.attach, total_fee = _req$body.total_fee, goods_tag = _req$body.goods_tag, product_id = _req$body.product_id, openid = _req$body.openid, unionid = _req$body.unionid;
                        ...
                        case 14:
                            ...
                            _context.next = 28;
                            return OrderDbService.initOrderInfo(params, origin, unionid);
