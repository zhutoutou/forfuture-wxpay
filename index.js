 ...
 * @param {string} [可选] configs.miniProgram.appSecret     微信小程序 App Secret
 ...
 * @param {string} [必须] configs.{origin}.mch              商户 配置信息
 * @param {string} [必须] configs.{origin}.mch.mch_id       商户唯一标识
 * @param {string} [可选] configs.{origin}.mch.notify_url   商户下单通知网络地址
 * @param {string} [必须] configs.{origin}.mch.fee_type     商户收款货币类型
 * @param {string} [必须] configs.{origin}.mch.sign_type    加密方式
